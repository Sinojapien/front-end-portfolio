    ...
    >
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid md:grid-cols-2 grid-cols-1 my-16 text-lg md:divide-x-2 md:divide-y-0 divide-y-2 ">
          <div className="flex flex-col gap-y-2 justify-center sm:p-6 p-4">
            <div>
          ...
          <div className="sm:p-6 p-4 md:text-center text-gray-600">
            An individual who is eager to apply his knowledge and experience in{" "}
        ...
        <div className="my-16">
          ...
          <ChipList
            className="py-8 px-2 justify-center"
            items={frontEndChips}
          />
          <div className="my-6" />
          <div className="text-center">
          ...
          <ChipList className="py-8 px-2 justify-center" items={otherChips} />
        </div>
      </div>
    </div>
  ),
